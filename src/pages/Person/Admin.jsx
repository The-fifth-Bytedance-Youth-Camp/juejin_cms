		...
		},
		{
			...
			render: (text, { id, name, email, password }, _, action) => [
				...
				<ModalForm
					...
					<ProForm.Group>
						<ProFormText width="md" name="up_email" label="邮箱" placeholder="请输入邮箱"
												 initialValue={ `${ email }` }/>
					</ProForm.Group>
					<ProForm.Group>
						<ProFormText.Password width="md" name="up_password" label="密码" type="password" placeholder="请输入密码"
			...
			<ProTable
				...
				toolBarRender={ () => [
					<ModalForm
						...
						<ProForm.Group>
							<ProFormText.Password width="md" name="ad_password" label="密码" type="password"
																		placeholder="请输入密码"/>
						</ProForm.Group>
					</ModalForm>,
				] }
